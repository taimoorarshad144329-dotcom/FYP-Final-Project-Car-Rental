...
<body>
    ...
    <div class="cars-section">
        ...
        <div class="cars-container">
            {{-- COPY PASTE CAR CARDS TO ADD MORE CARS --}}
            <div class="car-card">
        ...
        <div class="popup-content">
            ...
            <form id="rentForm">
                ...
                <div style="text-align: center;">
                    <button type="submit" class="btn btn-primary" style="background-color: #c1121f; color: white; margin: 0 auto;">Confirm Rental</button>
                </div>
            </form>
        </div>
    </div>
